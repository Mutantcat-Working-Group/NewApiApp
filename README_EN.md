...
Download the installer for your platform from [Releases](https://github.com/Mutantcat-Working-Group/NewApiApp/releases):
...
1. Install the app, enter the relay root URL, username and password, and sign in.
...
The app talks to the new-api panel REST API (panel endpoints under `/api`, relay endpoints under `/v1`):
